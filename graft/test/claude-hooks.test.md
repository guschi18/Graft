...
- writeMultiScopeWiring · function · L126-L145 — function writeMultiScopeWiring(d: string): void
- writeAskArgsStub · function · L247-L258 — function writeAskArgsStub(d: string): { stub: string; argsFile: string }
